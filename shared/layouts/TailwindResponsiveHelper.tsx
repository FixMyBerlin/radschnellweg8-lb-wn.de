...
export const TailwindResponsiveHelper = () => {
  if (ASTRO_ENV !== 'development') return null

  return (
    <a
      className="border-xl fixed bottom-1 left-1 z-10 flex h-5 flex-row items-center space-x-1 rounded-sm border border-white/70 bg-pink-300 px-1 text-xs shadow-xl hover:underline print:hidden"
