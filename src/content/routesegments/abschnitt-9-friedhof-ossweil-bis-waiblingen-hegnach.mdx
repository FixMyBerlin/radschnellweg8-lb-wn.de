---
title: 'Abschnitt 9: Friedhof Oßweil bis Waiblingen-Hegnach'
tsSlug: pa1.9
...
documents:
  - document: >-
      /files/abschnitt-9-friedhof-ossweil-bis-waiblingen-hegnach/documents/0/document.pages
    title: asdfd
socials:
  - type: instagram
    label: asdf
...
<Map type={{"discriminant":"routesegmentmap","value":"abschnitt-9-friedhof-ossweil-bis-waiblingen-hegnach"}} />
